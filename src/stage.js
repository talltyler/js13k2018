// based on http://github.com/bitnenfer/tiny-canvas
...
export default function Stage(canvas, width, height) {
  canvas.width = width;
  ...
  renderer = {
    ...
    image: function (texture, x, y, w, h, r, tx, ty, sx, sy, u0, v0, u1, v1) {
      let x0 = x,
        y0 = y,
        x1 = x + w,
        y1 = y + h,
